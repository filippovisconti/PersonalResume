...
\resumeItem{Installed and configured of \textbf{networks and servers}: firewall, proxy, reverse proxy, DNS, DHCP, VPN, IDS, IPS.}
\resumeItem{Managed hypervisors such as \textbf{Proxmox VE} and ESXi, with virtual machines and \textbf{LXC} and \textbf{Docker containers}, partially using Ansible}
...
{Master of Science in Computer Science}{Sept. 2022 -- est. July 2024}
\resumeItemListStart
